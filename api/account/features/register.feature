Feature: signup 注册测试
    ...
    Scenario Outline: 异常注册
        ...
        Examples:
            ...
            | hatlonely1                                                       | 131-45678901 | hatlonely1@foxmail.com | e010597fcf126d58fdfa36e636f8fc9e | 400    | invalid phone                                |
            | hatlonely1                                                       | 13145678901  | hatlonely1             | 0fe808594e47df1a336bafd8ab32f326 | 400    | invalid email                                |
            | hatlonely1                                                       | N/A          | N/A                    | de9baf2c5dde96f0a8b371117e936d4b | 400    | email and phone should not be empty together |
            | N/A                                                              | 13145678901  | hatlonely1@foxmail.com | de9baf2c5dde96f0a8b371117e936d4b | 400    | 必要字段                                     |
            | veryveryveryveryveryveryveryveryveryveryveryveryveryverylongname | 13145678901  | hatlonely1@foxmail.com | de9baf2c5dde96f0a8b371117e936d4b | 400    | 至多64个字符                                 |
